...

{
    ...
    {
        _Object_defineProperty(fn, 'name', { configurable: true, value: name });
        defineConstant(obj, name, fn);
    }
    ...
    defineFunction(typeof self === 'undefined' ? global : self, 'wuw', wuw);
    ...
    {
        const do_ = callback => doAs('wuw.do', callback);
    ...
    {
        const do_ = callback => doAs('wuw.doing.do', callback);
