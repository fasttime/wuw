...

{
    ...
    const init = () => initActions.forEach(action => action());
    ...
    (() =>
    {
        ...
        initActions.push(uninstallAllCallbacks);
    ...
    (() =>
    {
        ...
        const wuw = defineFunction(self, 'wuw', watch);
...

    {
        ...
        (() =>
        {
            ...
            const callPrintLiveRecordsLater = () => port2.postMessage(null);
        ...
        record =>
        {
            ...
            (
                ...
                'property key  ',
                '',
                formatPropertyKey(record.propertyKey),
                FIELD_CSS,
                'stack trace   ',
                record.splitStackTrace(),
                FIELD_CSS,
                'start time    ',
                record.startTime,
                FIELD_CSS,
        ...
        initActions.push(() => uninstallCallback(printLiveRecordLater));
